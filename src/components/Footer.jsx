    ...
    <footer className="bg-navy-950 text-gray-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm">
              ...
              <p>
                <a href="tel:+441252373232" className="hover:text-white transition-colors">
                  +44 (0) 1252 373232
                </a>
              </p>
              <p>
                <a href="mailto:info@baesystems.com" className="hover:text-white transition-colors">
                  info@baesystems.com
                </a>
              </p>
            </address>
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          <p className="text-gray-400">&copy; 2024 BAE Systems. All rights reserved.</p>
